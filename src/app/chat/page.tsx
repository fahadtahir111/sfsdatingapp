...
export default function ChatPage() {
  ...
  const newMatches = (conversations || []).filter(c => c.lastMessage === "No messages yet" || c.time === "New Match");
  const recentConvs = (conversations || []).filter(c => c.lastMessage !== "No messages yet" && c.time !== "New Match");
