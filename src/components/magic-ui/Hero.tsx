    ...
    <div className="w-full">
      <div className="container mx-auto">
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
          ...
          >
            <Button variant="secondary" size="sm" className="gap-4 rounded-full border border-white/10 bg-white/5 text-yellow-400 hover:bg-white/10">
            ...
            <h1 className="text-5xl md:text-8xl max-w-5xl tracking-tighter text-center font-black text-white leading-[0.9]">
              ...
              <span className="relative flex w-full justify-center overflow-hidden text-center md:pb-4 md:pt-4 min-h-[1.2em]">
                ...
                {titles.map((title, index) => (
                  <motion.span
                    key={index}
                    className="absolute font-black text-yellow-400 uppercase italic"
          ...
          <div className="flex flex-row gap-4 mt-10">
            ...
            <Button size="lg" className="gap-4 rounded-2xl bg-yellow-400 hover:bg-yellow-300 text-black shadow-2xl shadow-yellow-400/20 px-10 py-8 text-sm uppercase tracking-widest font-black transition-all hover:scale-105">
